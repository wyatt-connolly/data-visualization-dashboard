...
export default function Dashboard() {
  ...
  const [currentData, setCurrentData] = useState<ChartData>(filterData(co2Data, timeRange))
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs value={activeTab} onValueChange={(value: TabType) => setActiveTab(value)} className="space-y-8">
